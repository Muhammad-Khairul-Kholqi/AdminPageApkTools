...
const EditDataLearning = () => {
    return(
        <div>
            <div className = "bg-black mt-[20px] rounded-[10px] px-[10%] py-[40px] text-center text-white">
                <h1 className = "title-header text-[40px] leading-10 font-bold font-roboto-slab tracking-[2px]" >Edit Data Learning </h1> 
            </div>
            ...
            <div className="flex flex-wrap gap-[10px] items-center justify-center mt-[20px]">
                ...
                <p className="text-blue-600">Edit Data Learning</p>
            </div>
...
export default EditDataLearning;