    ...
    return(
        <div>
            <div className = "bg-black mt-[20px] rounded-[10px] px-[10%] py-[50px] text-center text-white">
                <h1 className = "title-header text-[40px] leading-10 font-bold font-roboto-slab tracking-[2px]" > Learning Resources </h1> 
            </div>

            <div className="bg-gray-100 p-[20px] mt-[20px] rounded-[10px]">
                <div className="flex flex-wrap gap-[10px] justify-between">
                    <p className="text-[20px] font-bold">Learning Resources</p>
                    <Link to="/add-data-learning">
