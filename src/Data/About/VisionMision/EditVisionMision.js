      ...
      <div className="bg-gray-100 p-[20px] rounded-[10px] mt-[20px]">
        ...
        <form>
          <div className="mt-[15px]">
            <label htmlFor="visi">vision:</label> 
            <ReactQuill id="visi" className="mt-[15px] bg-white"
              value={editorContent}
          ...
          <div className="mt-[15px]">
            <label htmlFor="misi">Mission:</label>
            <ReactQuill id="misi" className="mt-[15px] bg-white"
              value={editorContent}
              onChange={handleChange}
              modules={modules}
              formats={formats}
