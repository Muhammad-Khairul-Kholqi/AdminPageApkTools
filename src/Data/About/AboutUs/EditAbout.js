  ...
  return (
    <div>
      <div className="bg-black mt-[20px] rounded-[10px] px-[10%] py-[50px] text-center text-white"
        ...
        <h1 className="title-header text-[40px] leading-10 font-bold font-roboto-slab tracking-[2px]"> Edit Data About Us </h1>
      </div>
      <div className="flex flex-wrap gap-[10px] items-center justify-center mt-[20px]">
        <Link to="/data-about">
          <p className="hover:underline">Data About Us</p>
        </Link>

        <MdOutlineKeyboardArrowRight className="mt-[3px]" />

        <p className="text-blue-600">Edit Data About Us</p>
      </div>

      <div className="bg-gray-100 p-[20px] rounded-[10px] mt-[20px]">
        <h1 className="text-center font-bold text-[20px] mb-[20px]">Edit Data About Us</h1>
        <form>
